...
var SingleBoxSharedResizeObserver = class {
  ...
  _resizeSubject = new import_rxjs5.Subject();
  ...
  observe(target) {
    if (!this._elementObservables.has(target)) {
      this._elementObservables.set(target, new import_rxjs5.Observable((observer) => {
        ...
        (0, import_operators4.filter)((entries) => entries.some((entry) => entry.target === target)),
        // Share a replay of the last event so that subsequent calls to observe the same element
        // receive initial sizing info like the first one. Also enable ref counting so the
        // element will be automatically unobserved when there are no more subscriptions.
        (0, import_operators4.shareReplay)({
          bufferSize: 1,
          refCount: true
        }),
...
var DateAdapter = class {
  ...
  locale;
  _localeChanges = new import_rxjs6.Subject();
...
var MatFormFieldFloatingLabel = class _MatFormFieldFloatingLabel {
  ...
  _resizeSubscription = new import_rxjs7.Subscription();
  constructor() {
  }
  ngOnDestroy() {
    this._resizeSubscription.unsubscribe();
...
var MatFormField = class _MatFormField {
  ...
  _initializeControl(previousControl) {
    ...
    this._describedByChanges?.unsubscribe();
    this._describedByChanges = control.stateChanges.pipe((0, import_operators6.startWith)([void 0, void 0]), (0, import_operators6.map)(() => [control.errorState, control.userAriaDescribedBy]), (0, import_operators6.pairwise)(), (0, import_operators6.filter)(([[prevErrorState, prevDescribedBy], [currentErrorState, currentDescribedBy]]) => {
...
//# sourceMappingURL=chunk-5Q54IGRI.js.map
